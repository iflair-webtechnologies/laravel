...
class News extends Model
{
    ...
    /**
     * Query scope for news in primary region
     *
     * @param $query
     * @param Region $region
     * @return mixed
    ...
    /**
     * Query scope for news in secondary region
     *
     * @param $query
     * @param Region $region
     * @return mixed
    ...
    /**
     * Query scope for news in primary or secondary region
     *
     * @param $query
     * @param Region $region
     * @return mixed
    ...
    /**
     * Query scope for recently created news
     *
     * @param $query
     * @param Region $region
     * @return mixed
    ...
    /**
     * Query scope for news in category
     *
     * @param $query
    ...
    public function scopeInCategory($query, Category $category, Region $region)
    {
        ...
        return $query->whereHas('company.products.category', function ($q) use ($category) {
            $q->where('category.id', '=', $category->id);
        });
    }

    /**
     * Query scope for news in company
     *
     * @param $query
